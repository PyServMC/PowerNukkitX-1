...
public enum ParticleEffect {
    ...
    @Since("1.6.0.0-PN") CANDLE_FLAME("minecraft:candle_flame_particle"),
    ...
    @Since("1.6.0.0-PN") CROP_GROWTH_AREA("minecraft:crop_growth_area_emitter"),
    ...
    @Since("1.6.0.0-PN") DRIPSTONE_LAVA_DRIP("minecraft:stalactite_lava_drip_particle"),
    @Since("1.6.0.0-PN") DRIPSTONE_WATER_DRIP("minecraft:stalactite_water_drip_particle"),
    ...
    @Since("1.6.0.0-PN") GLOW("minecraft:glow_particle"),
    ...
    SCULK_SOUL("minecraft:sculk_soul_particle"),
    ...
    @Since("1.6.0.0-PN") SPORE_BLOSSOM_AMBIENT_BLOCK_ACTOR("minecraft:spore_blossom_ambient_particle"),
    @Since("1.6.0.0-PN") SPORE_BLOSSOM_SHOWER("minecraft:spore_blossom_shower_particle"),
    ...
    WARDEN_DIG_PARTICLE("minecraft:warden_dig"),
    ...
    @Since("1.6.0.0-PN") WAX("minecraft:wax_particle"),
