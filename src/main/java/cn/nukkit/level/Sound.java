...
public enum Sound {
    ...
    @Since("1.6.0.0-PN") AMBIENT_CANDLE("ambient.candle"),
    ...
    @Since("1.6.0.0-PN") BLOCK_BOWHIT("block.bowhit"),
    ...
    @Since("1.6.0.0-PN") BLOCK_CLICK("block.click"),
    ...
    @Since("1.6.0.0-PN") BUCKET_EMPTY_POWDER_SNOW("bucket.empty_powder_snow"),
    BUCKET_EMPTY_WATER("bucket.empty_water"),
    BUCKET_FILL_FISH("bucket.fill_fish"),
    BUCKET_FILL_LAVA("bucket.fill_lava"),
    @Since("1.6.0.0-PN") BUCKET_FILL_POWDER_SNOW("bucket.fill_powder_snow"),
    BUCKET_FILL_WATER("bucket.fill_water"),
    @Since("1.6.0.0-PN") CAKE_ADD_CANDLE("cake.add_candle"),
    ...
    @Since("1.6.0.0-PN") COPPER_WAX_OFF("copper.wax.off"),
    @Since("1.6.0.0-PN") COPPER_WAX_ON("copper.wax.on"),
    ...
    @Since("1.6.0.0-PN") DIG_AZALEA_LEAVES("dig.azalea_leaves"),
    DIG_BASALT("dig.basalt"),
    DIG_BONE_BLOCK("dig.bone_block"),
    @Since("1.6.0.0-PN") DIG_CANDLE("dig.candle"),
    @Since("1.6.0.0-PN") DIG_CAVE_VINES("dig.cave_vines"),
    DIG_CHAIN("dig.chain"),
    DIG_CLOTH("dig.cloth"),
    @Since("1.6.0.0-PN") DIG_COPPER("dig.copper"),
    DIG_CORAL("dig.coral"),
    @Since("1.6.0.0-PN") DIG_DEEPSLATE("dig.deepslate"),
    @Since("1.6.0.0-PN") DIG_DEEPSLATE_BRICKS("dig.deepslate_bricks"),
    DIG_FUNGUS("dig.fungus"),
    DIG_GRASS("dig.grass"),
    DIG_GRAVEL("dig.gravel"),
    DIG_HONEY_BLOCK("dig.honey_block"),
    DIG_LODESTONE("dig.lodestone"),
    @Since("1.6.0.0-PN") DIG_MOSS("dig.moss"),
    ...
    @Since("1.6.0.0-PN") DIG_POWDER_SNOW("dig.powder_snow"),
    DIG_ROOTS("dig.roots"),
    DIG_SAND("dig.sand"),
    ...
    DIG_VINES("dig.vines"),
    DIG_WOOD("dig.wood"),
    @Since("1.6.0.0-PN") DRIP_LAVA_POINTED_DRIPSTONE("drip.lava.pointed_dripstone"),
    @Since("1.6.0.0-PN") DRIP_WATER_POINTED_DRIPSTONE("drip.water.pointed_dripstone"),
    ...
    @Since("1.6.0.0-PN") EXTINGUISH_CANDLE("extinguish.candle"),
    @Since("1.6.0.0-PN") FALL_AMETHYST_BLOCK("fall.amethyst_block"),
    @Since("1.6.0.0-PN") FALL_AMETHYST_CLUSTER("fall.amethyst_cluster"),
    FALL_ANCIENT_DEBRIS("fall.ancient_debris"),
    @Since("1.6.0.0-PN") FALL_AZALEA("fall.azalea"),
    @Since("1.6.0.0-PN") FALL_AZALEA_LEAVES("fall.azalea_leaves"),
    FALL_BASALT("fall.basalt"),
    @Since("1.6.0.0-PN") FALL_BIG_DRIPLEAF("fall.big_dripleaf"),
    FALL_BONE_BLOCK("fall.bone_block"),
    @Since("1.6.0.0-PN") FALL_CALCITE("fall.calcite"),
    @Since("1.6.0.0-PN") FALL_CAVE_VINES("fall.cave_vines"),
    FALL_CHAIN("fall.chain"),
    FALL_CLOTH("fall.cloth"),
    @Since("1.6.0.0-PN") FALL_COPPER("fall.copper"),
    FALL_CORAL("fall.coral"),
    @Since("1.6.0.0-PN") FALL_DEEPSLATE("fall.deepslate"),
    @Since("1.6.0.0-PN") FALL_DEEPSLATE_BRICKS("fall.deepslate_bricks"),
    @Since("1.6.0.0-PN") FALL_DIRT_WITH_ROOTS("fall.dirt_with_roots"),
    @Since("1.6.0.0-PN") FALL_DRIPSTONE_BLOCK("fall.dripstone_block"),
    FALL_EGG("fall.egg"),
    FALL_GRASS("fall.grass"),
    FALL_GRAVEL("fall.gravel"),
    @Since("1.6.0.0-PN") FALL_HANGING_ROOTS("fall.hanging_roots"),
    FALL_HONEY_BLOCK("fall.honey_block"),
    FALL_LADDER("fall.ladder"),
    @Since("1.6.0.0-PN") FALL_MOSS("fall.moss"),
    ...
    @Since("1.6.0.0-PN") FALL_POINTED_DRIPSTONE("fall.pointed_dripstone"),
    @Since("1.6.0.0-PN") FALL_POWDER_SNOW("fall.powder_snow"),
    ...
    @Since("1.6.0.0-PN") FALL_SPORE_BLOSSOM("fall.spore_blossom"),
    FALL_STEM("fall.stem"),
    FALL_STONE("fall.stone"),
    @Since("1.6.0.0-PN") FALL_TUFF("fall.tuff"),
    ...
    HIT_ANVIL("hit.anvil"),
    @Since("1.6.0.0-PN") HIT_AZALEA("hit.azalea"),
    @Since("1.6.0.0-PN") HIT_AZALEA_LEAVES("hit.azalea_leaves"),
    HIT_BASALT("hit.basalt"),
    @Since("1.6.0.0-PN") HIT_BIG_DRIPLEAF("hit.big_dripleaf"),
    HIT_BONE_BLOCK("hit.bone_block"),
    @Since("1.6.0.0-PN") HIT_CALCITE("hit.calcite"),
    @Since("1.6.0.0-PN") HIT_CANDLE("hit.candle"),
    @Since("1.6.0.0-PN") HIT_CAVE_VINES("hit.cave_vines"),
    HIT_CHAIN("hit.chain"),
    HIT_CLOTH("hit.cloth"),
    @Since("1.6.0.0-PN") HIT_COPPER("hit.copper"),
    HIT_CORAL("hit.coral"),
    @Since("1.6.0.0-PN") HIT_DEEPSLATE("hit.deepslate"),
    @Since("1.6.0.0-PN") HIT_DEEPSLATE_BRICKS("hit.deepslate_bricks"),
    @Since("1.6.0.0-PN") HIT_DIRT_WITH_ROOTS("hit.dirt_with_roots"),
    @Since("1.6.0.0-PN") HIT_DRIPSTONE_BLOCK("hit.dripstone_block"),
    HIT_GRASS("hit.grass"),
    HIT_GRAVEL("hit.gravel"),
    @Since("1.6.0.0-PN") HIT_HANGING_ROOTS("hit.hanging_roots"),
    HIT_HONEY_BLOCK("hit.honey_block"),
    HIT_LADDER("hit.ladder"),
    @Since("1.6.0.0-PN") HIT_MOSS("hit.moss"),
    ...
    @Since("1.6.0.0-PN") HIT_POINTED_DRIPSTONE("hit.pointed_dripstone"),
    @Since("1.6.0.0-PN") HIT_POWDER_SNOW("hit.powder_snow"),
    HIT_ROOTS("hit.roots"),
    HIT_SAND("hit.sand"),
    HIT_SCULK("hit.sculk"),
    ...
    @Since("1.6.0.0-PN") HIT_SPORE_BLOSSOM("hit.spore_blossom"),
    HIT_STEM("hit.stem"),
    HIT_STONE("hit.stone"),
    @Since("1.6.0.0-PN") HIT_TUFF("hit.tuff"),
    HIT_VINES("hit.vines"),
    HIT_WOOD("hit.wood"),
    ...
    @Since("1.6.0.0-PN") ITEM_SPYGLASS_STOP_USING("item.spyglass.stop_using"),
    @Since("1.6.0.0-PN") ITEM_SPYGLASS_USE("item.spyglass.use"),
    ...
    @Since("1.6.0.0-PN") JUMP_AZALEA("jump.azalea"),
    JUMP_BASALT("jump.basalt"),
    @Since("1.6.0.0-PN") JUMP_BIG_DRIPLEAF("jump.big_dripleaf"),
    JUMP_BONE_BLOCK("jump.bone_block"),
    @Since("1.6.0.0-PN") JUMP_CAVE_VINES("jump.cave_vines"),
    JUMP_CHAIN("jump.chain"),
    JUMP_CLOTH("jump.cloth"),
    JUMP_CORAL("jump.coral"),
    @Since("1.6.0.0-PN") JUMP_DEEPSLATE("jump.deepslate"),
    @Since("1.6.0.0-PN") JUMP_DEEPSLATE_BRICKS("jump.deepslate_bricks"),
    @Since("1.6.0.0-PN") JUMP_DIRT_WITH_ROOTS("jump.dirt_with_roots"),
    @Since("1.6.0.0-PN") JUMP_DRIPSTONE_BLOCK("jump.dripstone_block"),
    JUMP_GRASS("jump.grass"),
    JUMP_GRAVEL("jump.gravel"),
    @Since("1.6.0.0-PN") JUMP_HANGING_ROOTS("jump.hanging_roots"),
    JUMP_HONEY_BLOCK("jump.honey_block"),
    @Since("1.6.0.0-PN") JUMP_MOSS("jump.moss"),
    ...
    @Since("1.6.0.0-PN") JUMP_POINTED_DRIPSTONE("jump.pointed_dripstone"),
    ...
    @Since("1.6.0.0-PN") JUMP_SPORE_BLOSSOM("jump.spore_blossom"),
    JUMP_STEM("jump.stem"),
    JUMP_STONE("jump.stone"),
    JUMP_VINES("jump.vines"),
    JUMP_WOOD("jump.wood"),
    LAND_ANCIENT_DEBRIS("land.ancient_debris"),
    @Since("1.6.0.0-PN") LAND_AZALEA("land.azalea"),
    LAND_BASALT("land.basalt"),
    @Since("1.6.0.0-PN") LAND_BIG_DRIPLEAF("land.big_dripleaf"),
    LAND_BONE_BLOCK("land.bone_block"),
    @Since("1.6.0.0-PN") LAND_CAVE_VINES("land.cave_vines"),
    LAND_CHAIN("land.chain"),
    LAND_CLOTH("land.cloth"),
    LAND_CORAL("land.coral"),
    @Since("1.6.0.0-PN") LAND_DEEPSLATE("land.deepslate"),
    @Since("1.6.0.0-PN") LAND_DEEPSLATE_BRICKS("land.deepslate_bricks"),
    @Since("1.6.0.0-PN") LAND_DIRT_WITH_ROOTS("land.dirt_with_roots"),
    @Since("1.6.0.0-PN") LAND_DRIPSTONE_BLOCK("land.dripstone_block"),
    LAND_GRASS("land.grass"),
    LAND_GRAVEL("land.gravel"),
    @Since("1.6.0.0-PN") LAND_HANGING_ROOTS("land.hanging_roots"),
    LAND_HONEY_BLOCK("land.honey_block"),
    @Since("1.6.0.0-PN") LAND_MOSS("land.moss"),
    ...
    @Since("1.6.0.0-PN") LAND_POINTED_DRIPSTONE("land.pointed_dripstone"),
    ...
    @Since("1.6.0.0-PN") LAND_SPORE_BLOSSOM("land.spore_blossom"),
    LAND_STEM("land.stem"),
    ...
    @Since("1.6.0.0-PN") MOB_AXOLOTL_ATTACK("mob.axolotl.attack"),
    @Since("1.6.0.0-PN") MOB_AXOLOTL_DEATH("mob.axolotl.death"),
    @Since("1.6.0.0-PN") MOB_AXOLOTL_HURT("mob.axolotl.hurt"),
    @Since("1.6.0.0-PN") MOB_AXOLOTL_IDLE("mob.axolotl.idle"),
    @Since("1.6.0.0-PN") MOB_AXOLOTL_IDLE_WATER("mob.axolotl.idle_water"),
    @Since("1.6.0.0-PN") MOB_AXOLOTL_SPLASH("mob.axolotl.splash"),
    @Since("1.6.0.0-PN") MOB_AXOLOTL_SWIM("mob.axolotl.swim"),
    ...
    @Since("1.6.0.0-PN") MOB_PLAYER_HURT_DROWN("mob.player.hurt_drown"),
    @Since("1.6.0.0-PN") MOB_PLAYER_HURT_FREEZE("mob.player.hurt_freeze"),
    @Since("1.6.0.0-PN") MOB_PLAYER_HURT_ON_FIRE("mob.player.hurt_on_fire"),
    ...
    @Since("1.6.0.0-PN") MOB_SKELETON_CONVERT_TO_STRAY("mob.skeleton.convert_to_stray"),
    ...
    @Since("1.6.0.0-PN") MOB_SQUID_INK_SQUIRT("mob.squid.ink_squirt"),
    ...
    @Since("1.6.0.0-PN") MUSIC_GAME_BASALT_DELTAS("music.game.basalt_deltas"),
    ...
    @Since("1.6.0.0-PN") MUSIC_GAME_FROZEN_PEAKS("music.game.frozen_peaks"),
    @Since("1.6.0.0-PN") MUSIC_GAME_GROVE("music.game.grove"),
    @Since("1.6.0.0-PN") MUSIC_GAME_JAGGED_PEAKS("music.game.jagged_peaks"),
    @Since("1.6.0.0-PN") MUSIC_GAME_LUSH_CAVES("music.game.lush_caves"),
    @Since("1.6.0.0-PN") MUSIC_GAME_MEADOW("music.game.meadow"),
    ...
    @Since("1.6.0.0-PN") STEP_AZALEA("step.azalea"),
    @Since("1.6.0.0-PN") STEP_AZALEA_LEAVES("step.azalea_leaves"),
    STEP_BASALT("step.basalt"),
    @Since("1.6.0.0-PN") STEP_BIG_DRIPLEAF("step.big_dripleaf"),
    STEP_BONE_BLOCK("step.bone_block"),
    @Since("1.6.0.0-PN") STEP_CALCITE("step.calcite"),
    @Since("1.6.0.0-PN") STEP_CANDLE("step.candle"),
    @Since("1.6.0.0-PN") STEP_CAVE_VINES("step.cave_vines"),
    STEP_CHAIN("step.chain"),
    STEP_CLOTH("step.cloth"),
    @Since("1.6.0.0-PN") STEP_COPPER("step.copper"),
    ...
    @Since("1.6.0.0-PN") STEP_HANGING_ROOTS("step.hanging_roots"),
    STEP_HONEY_BLOCK("step.honey_block"),
    STEP_LADDER("step.ladder"),
    @Since("1.6.0.0-PN") STEP_MOSS("step.moss"),
    ...
    @Since("1.6.0.0-PN") STEP_POINTED_DRIPSTONE("step.pointed_dripstone"),
    @Since("1.6.0.0-PN") STEP_POWDER_SNOW("step.powder_snow"),
    ...
    @Since("1.6.0.0-PN") STEP_SPORE_BLOSSOM("step.spore_blossom"),
    STEP_STEM("step.stem"),
    STEP_STONE("step.stone"),
    @Since("1.6.0.0-PN") STEP_TUFF("step.tuff"),
    STEP_VINES("step.vines"),
    STEP_WOOD("step.wood"),
    TILE_PISTON_IN("tile.piston.in"),
    TILE_PISTON_OUT("tile.piston.out"),
    @Since("1.6.0.0-PN") TILT_DOWN_BIG_DRIPLEAF("tilt_down.big_dripleaf"),
    @Since("1.6.0.0-PN") TILT_UP_BIG_DRIPLEAF("tilt_up.big_dripleaf"),
    ...
    @Since("1.6.0.0-PN") USE_CANDLE("use.candle"),
    @Since("1.6.0.0-PN") USE_CAVE_VINES("use.cave_vines"),
    USE_CHAIN("use.chain"),
    USE_CLOTH("use.cloth"),
    @Since("1.6.0.0-PN") USE_COPPER("use.copper"),
    USE_CORAL("use.coral"),
    @Since("1.6.0.0-PN") USE_DEEPSLATE("use.deepslate"),
    @Since("1.6.0.0-PN") USE_DEEPSLATE_BRICKS("use.deepslate_bricks"),
    @Since("1.6.0.0-PN") USE_DIRT_WITH_ROOTS("use.dirt_with_roots"),
    @Since("1.6.0.0-PN") USE_DRIPSTONE_BLOCK("use.dripstone_block"),
    USE_GRASS("use.grass"),
    USE_GRAVEL("use.gravel"),
    @Since("1.6.0.0-PN") USE_HANGING_ROOTS("use.hanging_roots"),
    USE_HONEY_BLOCK("use.honey_block"),
    USE_LADDER("use.ladder"),
    @Since("1.6.0.0-PN") USE_MOSS("use.moss"),
    ...
    @Since("1.6.0.0-PN") USE_POINTED_DRIPSTONE("use.pointed_dripstone"),
    USE_ROOTS("use.roots"),
    USE_SAND("use.sand"),
    ...
    @Since("1.6.0.0-PN") USE_SPORE_BLOSSOM("use.spore_blossom"),
    USE_STEM("use.stem"),
    USE_STONE("use.stone"),
    USE_VINES("use.vines"),
    USE_WOOD("use.wood"),
