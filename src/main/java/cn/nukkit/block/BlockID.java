...
public interface BlockID {
    ...
    // 564 (unused)
    // 565 (unused)
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COPPER_ORE = 566;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int LIGHTNING_ROD = 567;
    // 568 (unused)
    // 569 (unused)
    // 570 (unused)
    // 571 (unused)
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DRIPSTONE_BLOCK = 572;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DIRT_WITH_ROOTS = 573;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int HANGING_ROOTS = 574;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int MOSS_BLOCK = 575;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int SPORE_BLOSSOM = 576;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CAVE_VINES = 577;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int BIG_DRIPLEAF = 578;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int AZALEA_LEAVES = 579;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int AZALEA_LEAVES_FLOWERED = 580;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CALCITE = 581;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int AMETHYST_BLOCK = 582;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int BUDDING_AMETHYST = 583;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int AMETHYST_CLUSTER = 584;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int LARGE_AMETHYST_BUD = 585;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int MEDIUM_AMETHYST_BUD = 586;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int SMALL_AMETHYST_BUD = 587;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int TUFF = 588;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int TINTED_GLASS = 589;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int MOSS_CARPET = 590;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int SMALL_DRIPLEAF_BLOCK = 591;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int AZALEA = 592;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int FLOWERING_AZALEA = 593;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int GLOW_FRAME = 594;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COPPER_BLOCK = 595;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int EXPOSED_COPPER = 596;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WEATHERED_COPPER = 597;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int OXIDIZED_COPPER = 598;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_COPPER = 599;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_EXPOSED_COPPER = 600;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_WEATHERED_COPPER = 601;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CUT_COPPER = 602;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int EXPOSED_CUT_COPPER = 603;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WEATHERED_CUT_COPPER = 604;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int OXIDIZED_CUT_COPPER = 605;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_CUT_COPPER = 606;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_EXPOSED_CUT_COPPER = 607;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_WEATHERED_CUT_COPPER = 608;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CUT_COPPER_STAIRS = 609;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int EXPOSED_CUT_COPPER_STAIRS = 610;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WEATHERED_CUT_COPPER_STAIRS = 611;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int OXIDIZED_CUT_COPPER_STAIRS = 612;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_CUT_COPPER_STAIRS = 613;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_EXPOSED_CUT_COPPER_STAIRS = 614;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_WEATHERED_CUT_COPPER_STAIRS = 615;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CUT_COPPER_SLAB = 616;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int EXPOSED_CUT_COPPER_SLAB = 617;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WEATHERED_CUT_COPPER_SLAB = 618;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int OXIDIZED_CUT_COPPER_SLAB = 619;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_CUT_COPPER_SLAB = 620;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_EXPOSED_CUT_COPPER_SLAB = 621;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_WEATHERED_CUT_COPPER_SLAB = 622;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DOUBLE_CUT_COPPER_SLAB = 623;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int EXPOSED_DOUBLE_CUT_COPPER_SLAB = 624;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WEATHERED_DOUBLE_CUT_COPPER_SLAB = 625;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int OXIDIZED_DOUBLE_CUT_COPPER_SLAB = 626;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_DOUBLE_CUT_COPPER_SLAB = 627;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_EXPOSED_DOUBLE_CUT_COPPER_SLAB = 628;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WAXED_WEATHERED_DOUBLE_CUT_COPPER_SLAB = 629;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CAVE_VINES_BODY_WITH_BERRIES = 630;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CAVE_VINES_HEAD_WITH_BERRIES = 631;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int SMOOTH_BASALT = 632;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE = 633;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COBBLED_DEEPSLATE = 634;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COBBLED_DEEPSLATE_SLAB = 635;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COBBLED_DEEPSLATE_STAIRS = 636;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COBBLED_DEEPSLATE_WALL = 637;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int POLISHED_DEEPSLATE = 638;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int POLISHED_DEEPSLATE_SLAB = 639;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int POLISHED_DEEPSLATE_STAIRS = 640;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int POLISHED_DEEPSLATE_WALL = 641;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_TILES = 642;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_TILE_SLAB = 643;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_TILE_STAIRS = 644;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_TILE_WALL = 645;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_BRICKS = 646;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_BRICK_SLAB = 647;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_BRICK_STAIRS = 648;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_BRICK_WALL = 649;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CHISELED_DEEPSLATE = 650;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int COBBLED_DEEPSLATE_DOUBLE_SLAB = 651;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int POLISHED_DEEPSLATE_DOUBLE_SLAB = 652;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_TILE_DOUBLE_SLAB = 653;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_BRICK_DOUBLE_SLAB = 654;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_LAPIS_ORE = 655;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_IRON_ORE = 656;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_GOLD_ORE = 657;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_REDSTONE_ORE = 658;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int LIT_DEEPSLATE_REDSTONE_ORE = 659;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_DIAMOND_ORE = 660;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_COAL_ORE = 661;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_EMERALD_ORE = 662;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int DEEPSLATE_COPPER_ORE = 663;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CRACKED_DEEPSLATE_TILES = 664;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CRACKED_DEEPSLATE_BRICKS = 665;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int GLOW_LICHEN = 666;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CANDLE = 667;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WHITE_CANDLE = 668;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int ORANGE_CANDLE = 669;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int MAGENTA_CANDLE = 670;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int LIGHT_BLUE_CANDLE = 671;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int YELLOW_CANDLE = 672;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int LIME_CANDLE = 673;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int PINK_CANDLE = 674;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int GRAY_CANDLE = 675;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int LIGHT_GRAY_CANDLE = 676;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CYAN_CANDLE = 677;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int PURPLE_CANDLE = 678;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int BLUE_CANDLE = 679;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int BROWN_CANDLE = 680;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int GREEN_CANDLE = 681;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int RED_CANDLE = 682;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int BLACK_CANDLE = 683;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int CANDLE_CAKE = 684;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int WHITE_CANDLE_CAKE = 685;
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int ORANGE_CANDLE_CAKE = 686;
    ...
    @Since("1.6.0.0-PNX") @PowerNukkitOnly int FROG_SPAWN = 723;
